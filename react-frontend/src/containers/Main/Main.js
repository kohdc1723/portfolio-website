	...
	return (
		<div>
			<div className="text-center py-3">
				<h3 className="text-2xl font-bebasneue text-slate-700 py-1 md:text-3xl">Hello, I'm</h3>
				<h2 className="text-5xl font-bebasneue text-indigo-700 font-medium py-1 md:text-6xl">Dong-chan Koh</h2>
				<h3 className="text-2xl font-bebasneue text-slate-700 py-1 md:text-3xl">seeking a Software Developer job</h3>
			...
			<div className="flex justify-center gap-16 text-5xl py-3 text-indigo-500">
